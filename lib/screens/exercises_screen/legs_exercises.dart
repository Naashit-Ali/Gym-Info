...
class LegsExercises extends StatefulWidget {
  final String exerciseId;

  const LegsExercises({Key? key, required this.exerciseId, required }) : super(key: key);

  @override
  _LegsExercisesState createState() => _LegsExercisesState();
}

class _LegsExercisesState extends State<LegsExercises> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      body: StreamBuilder(
        stream: FirebaseFirestore.instance.collection('legs').doc(widget.exerciseId).snapshots(),
