...
class ShoulderExercises extends StatefulWidget {
  final String exerciseId;

  const ShoulderExercises({Key? key, required this.exerciseId, required }) : super(key: key);

  @override
  _ShoulderExercisesState createState() => _ShoulderExercisesState();
}

class _ShoulderExercisesState extends State<ShoulderExercises> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      body: StreamBuilder(
        stream: FirebaseFirestore.instance.collection('shoulders').doc(widget.exerciseId).snapshots(),
