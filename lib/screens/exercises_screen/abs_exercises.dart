...
class AbsExercises extends StatefulWidget {
  final String exerciseId;

  const AbsExercises({Key? key, required this.exerciseId, required }) : super(key: key);

  @override
  _AbsExercisesState createState() => _AbsExercisesState();
}

class _AbsExercisesState extends State<AbsExercises> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      body: StreamBuilder(
        stream: FirebaseFirestore.instance.collection('abs').doc(widget.exerciseId).snapshots(),
